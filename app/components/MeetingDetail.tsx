        ...
        <article className="space-y-8 rounded-xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <header className="border-b border-slate-200 pb-6">
                ...
                <h1 className="mt-2 text-3xl font-bold text-slate-900">
                    {new Date(`${meeting.date}T00:00:00`).toLocaleDateString("en-ZA", {
                        weekday: "long",
                        year: "numeric",
                        month: "long",
                        day: "numeric",
            ...
            <section aria-labelledby="leadership-heading">
                ...
                <dl className="mt-4 grid gap-4 sm:grid-cols-2">
                    <div className="rounded-lg bg-slate-50 p-4">
                        ...
                        <dd className="mt-1 text-slate-600">{meeting.presiding}</dd>
                    </div>

                    <div className="rounded-lg bg-slate-50 p-4">
                        <dt className="font-semibold text-slate-900">Conducting</dt>
                        <dd className="mt-1 text-slate-600">{meeting.conducting}</dd>
                    </div>
                </dl>
            </section>

            <section aria-labelledby="hymns-heading">
                <h2 id="hymns-heading" className="text-xl font-bold text-slate-900">
                    Hymns
                </h2>

                <div className="mt-4 grid gap-4 sm:grid-cols-3">
                    <Hymn label="Opening Hymn" hymn={meeting.openingHymn} />
                    ...
                    <Hymn label="Closing Hymn" hymn={meeting.closingHymn} />
                </div>
            </section>

            <section aria-labelledby="prayers-heading">
                <h2 id="prayers-heading" className="text-xl font-bold text-slate-900">
                    Prayers
                </h2>

                <dl className="mt-4 grid gap-4 sm:grid-cols-2">
                    <div className="rounded-lg bg-slate-50 p-4">
                        <dt className="font-semibold text-slate-900">Opening Prayer</dt>
                    ...
                    <div className="rounded-lg bg-slate-50 p-4">
                        <dt className="font-semibold text-slate-900">Closing Prayer</dt>
                        <dd className="mt-1 text-slate-600">
            ...
            <section aria-labelledby="speakers-heading">
                <h2 id="speakers-heading" className="text-xl font-bold text-slate-900">
                    Speakers
                </h2>
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                    {meeting.speakers.map((speaker) => (
                        ...
                        >
                            ...
                            <p className="mt-1 text-slate-600">{speaker.topic}</p>
                        </div>
                    ))}
                </div>
            </section>
